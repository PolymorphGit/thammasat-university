	...
	callback = function(results) {
		...
		results.on('end', function() {
			...
			.then(function(results) {
					...
					query += " UNION ALL ";
				    query += "SELECT sfid, caseid as name, 'clean' as type, working_date__c as detail, createddate FROM salesforce.WorkOrder WHERE accountid='" + results[0].sfid + "' and working_date__c is not null";
